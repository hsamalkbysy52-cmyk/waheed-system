  ...
  return (
    <div style={{ padding: "28px", direction: "rtl", background: "#0a0a1a", minHeight: "100%", fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      ...
      <div style={{ marginBottom: "28px" }}>
        ...
        <p style={{ margin: "6px 0 0", color: "#8892b0", fontSize: "13px" }}>اسأل عن مبيعاتك وأداء المطعم بالذكاء الاصطناعي</p>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "24px", alignItems: "start" }}>
        ...
        <div>
          {/* API Key */}
          <div style={{ background: "#13132a", border: "1px solid #2a2a4a", borderRadius: "16px", padding: "20px", marginBottom: "20px" }}>
            <p style={{ margin: "0 0 10px", color: "#f39c12", fontSize: "13px", fontWeight: "700" }}>🔑 OpenAI API Key</p>
            <input
              type="password"
              placeholder="sk-..."
              value={apiKey}
            ...
            />
            <p style={{ margin: "8px 0 0", color: "#8892b0", fontSize: "11px" }}>المفتاح لا يُحفظ في أي مكان</p>
          </div>

          {/* Quick questions */}
          <div style={{ background: "#13132a", border: "1px solid #2a2a4a", borderRadius: "16px", padding: "20px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              {QUICK.map(q => (
                <button key={q} onClick={() => setQuestion(q)} style={{
                  padding: "11px 14px", background: question === q ? "rgba(243,156,18,0.12)" : "#0a0a1a",
                  color: question === q ? "#f39c12" : "#8892b0",
        ...
        <div>
          ...
          {answer && (
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
                ...
                <span style={{ color: "#f39c12", fontSize: "13px", fontWeight: "700" }}>رد المساعد الذكي</span>
              </div>
          ...
          {!answer && !loading && (
            <div style={{
              ...
              borderRadius: "16px", padding: "48px", textAlign: "center", color: "#8892b0",
            }}>
