...
function StatCard({ label, value, color, icon }: { label: string; value: number | string; color: string; icon: string }) {
  return (
    <div style={{
      ...
      <div style={{ color: "var(--text2)", fontSize: "13px", marginTop: "4px" }}>{label}</div>
    </div>
  );
}
    ...
    <div style={{ padding: "24px", direction: "rtl", background: "var(--bg)", minHeight: "100%", fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
          <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "var(--red)", boxShadow: "0 0 8px #e74c3c" }} />
        ...
        {pending.length === 0 ? (
          <div style={{ background: "var(--surface)", border: "1px solid #2a2a4a", borderRadius: "16px", padding: "40px", textAlign: "center", color: "var(--text2)" }}>
              ...
              <div key={order.id} style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "12px" }}>
                  <div>
                    ...
                    <div style={{ color: "var(--text2)", fontSize: "12px", marginTop: "3px" }}>🪑 طاولة {order.table_number}</div>
                  </div>
                  <span style={{
