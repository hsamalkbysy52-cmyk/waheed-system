...
- **Unused `zustand` dependency** — the store it powered went with the chat bot's rewrite (ticket 14, 2026-09-05); remove it when the frontend's dependencies are next touched.
