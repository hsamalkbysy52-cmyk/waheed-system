...
- **Demo Table layout in `bootstrap_dev`** — the seed creates the demo Restaurant, its three accounts, the menu with a Modifier group and the Inventory with Recipes; the Table layout waits for ticket 07 (handoff recorded there). Decided in ticket 04 (2026-09-04).
